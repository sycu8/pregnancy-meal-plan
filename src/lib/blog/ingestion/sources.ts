...
export const blogSources: SourceConfig[] = [
  ...
  },
  {
    ...
    topics: ["pregnancy", "nutrition", "food", "safety", "breastfeeding", "infant"],
    credibility: "official",
    language: "en",
    enabled: true,
  ...
  },
  {
    ...
    allowedPaths: ["/vie/bai-viet/", "/vie/chuyen-khoa/san-phu", "/eng/"],
    topics: ["thai", "san", "mang thai", "dinh duong", "me bau", "sau sinh", "pregnancy", "nutrition"],
    credibility: "hospital",
    language: "vi",
    enabled: true,
